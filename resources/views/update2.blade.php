  ...
  <div class="container">
   ...
   <div class="main">
    ...
    <form action="/update2" method="post">
        @csrf
        <input type="text" name="id" value="{{$data['id']}}" placeholder="Enter id">
        <input type="text" name="level" value="{{$data['level']}}"  placeholder="Enter type">
        <br><br>
        <!--<input type="text" name="question" value="{{$data['question']}}" placeholder="Enter question" class="inpq">-->
        <br><br>
        <input type="text" name="a" value="{{$data['a']}}"  placeholder="Enter answer1">
        <input type="text" name="b" value="{{$data['b']}}"  placeholder="Enter answer2">
        <input type="text" name="c" value="{{$data['c']}}"  placeholder="Enter answer3">
        <input type="text" name="d" value="{{$data['d']}}"  placeholder="Enter answer4"> 
        <br><br>   
        <input type="text" name="ans" value="{{$data['ans']}}"  placeholder="Enter the correct answer">
        <br><br>
    
        <button class="btn btn-primary" type="submit"><a>Update</a></button>
        <button class="btn btn-primary" ><a href="/site_arbi/videos">Back </a></button>
      </form>
