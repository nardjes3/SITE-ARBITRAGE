            ...
            <main class="table">
              <section class="table__header">
                ...
                <div class="input-group">
                  <button  ><a href="{{URL('index_u')}}"> Add Video !</a></button>
                </div>
              </section>
                    ...
                    <tbody>
                      ...
                      <tr>
                       ...
                       <!-- <td>{{$member['question']}}</td>-->
                         <td>
                          <a href={{"update2/".$member['id']}} class="text-black btn btn-succes ml-2 pt-2">
                            <i class="fa-sharp fa-solid fa-pen-to-square"></i>
                          </a>
                          
                          <a href={{"delete2/".$member['id']}} class="text-black btn btn-danger ml-2 pt-2">
                            <i class="fa fa-trash"></i>
                          </a>
                          <!--<a href={{"report/".$member['id']}} class="text-black btn btn-warning ml-2 pt-2">
                            <i class="fa fa-eye"></i>-->
                          </a>
                        </td>           
                      </tr>
