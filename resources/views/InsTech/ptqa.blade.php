          ...
          <div class="container3">
            ...
            <main class="table">
              <section class="table__header">
                <h1> <i> Please Select Questions for a Question Quiz :</i> </h1>
                  ...
                  <table class="table" >
                    ...
                    <tbody>
                      ...
                      <tr  id="{{$member['id']}}">
                        ...
                        <td>{{$member['level']}}</td>
                        <td>
                          <input type="checkbox" class="selected_question" option_id="1"> 
                        </td>           
                      </tr>
                      @endforeach
                    </tbody>
            ...
            <script>
               $("#validate").on("click",(e)=>{
                ...
                $(".selected_question:checked").each(function(){
                      selected_questions.push($(this).parent().parent().attr("id"));
                });
                  $.ajax({
                                url : "/create_test",
                                type: "GET",
