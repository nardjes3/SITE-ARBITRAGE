  ...
  <div class="container">
   ...
   <div class="main">
    ...
    <p>Add Video</p>
          ...
          <form action="/add2" method="post" enctype="multipart/form-data" enctype="multipart/form-data">
              @csrf
              <input type="text" name="id"  placeholder="Enter id" class="inp">
              <br><br>
              <input type="text" name="title"  placeholder="Enter title" class="inp">
              <br><br>
              <input type="text" name="description"   placeholder="Enter description" class="inp">
              <br><br>
               
              <input type="text" name="type"   placeholder="Enter type" class="inp">
              <br><br>
              <div class="drag-area">
              ...
              <br>
              <button class="btn btn-primary" type="submit"><a href="InsTech/videos">Add</a></button>
