          ...
          <div class="container3">
            ...
            <main class="table">
              <section class="table__header">
                <h1> <i>Please choose the test that you want to share :</i> </h1>
                  ...
                  <table class="table" >
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{$member['niveau']}}</td>
                        <td>
                          <a href={{"view_vid/".$member['id']}} class="text-black btn btn-succes ml-2 pt-2" style="color:blue">
                            <i class="fa fa-eye"></i>
                          </a>   
                        </td>
                        <td>
                            <a id="{{$member['id']}}" href="de" class="text-black btn btn-succes ml-2 pt-2 share-btn" style="color:green">
