          ...
          <div class="container3">
            ...
            <main class="table">
              <section class="table__header">
                <h1> <i> Please Select Videos for a Video Quiz :</i> </h1>
                <div class="input-group">
                  <button id="validate"><a href="{{URL('')}}">Validate ! </a></button>
                </div>
                <div class="alert hide"> 
                  <span class="fas fa-check-circle"></span>
                  <span class="msg">Succes : Test Created with succes</span>
                  <div class="close-btn">
                ...
                <div class="tb">
                  <table class="table" >
                    ...
                    <tbody>
                      ...
                      <tr  id="{{$member['id']}}">
                        <td><video width="320" height="240" autoplay muted class="vid">
                          <source src="{{asset('upload')}}/{{$member['video']}}" type="video/mp4"></td>
                        <td>{{$member['level']}}</td>
                        <td>
                          <input type="checkbox" class="selected_video" option_id="1"> 
                        </td>           
                      </tr>
                      @endforeach
                    </tbody>
            ...
            <script>
               $("#validate").on("click",(e)=>{
                e.preventDefault();
                let selected_videos = [];
                $(".selected_video:checked").each(function(){
                      selected_videos.push($(this).parent().parent().attr("id"));
                });
                  $.ajax({
                                url : "/create_test2",
                                type: "GET",
