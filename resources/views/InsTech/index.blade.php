   ...
   <div class="main">
    ...
    <p>Add Video</p>
              <div class="drag-area">
                ...
                {{ csrf_field() }}
                <!--<input type="text" name="id"   placeholder="Enter id" class="inp">-->
                <input type="text" name="level"   placeholder="Enter level : Beginners or Advanceds" class="inp">
                <br><br>
                <!--<input type="text" name="question"   placeholder="Enter question" class="inpq">-->
                <br><br>
              <input type="text" name="a"   placeholder="Enter answer1"class="inp">
              <input type="text" name="b"   placeholder="Enter answer2" class="inp">
              <input type="text" name="c"   placeholder="Enter answer3" class="inp">
              <input type="text" name="d"   placeholder="Enter answer4" class="inp">
              <br><br>
              <input type="text" name="ans"   placeholder="Enter the correct answer" class="inp">
              <br><br>
                    ...
                    <input type="submit" name="click" class="envo" class="btn"/>
                </form>
