            ...
            <main class="table">
              <section class="table__header">
                ...
                <div class="input-group">
                  <button  ><a href="{{URL('add')}}"> Add Question !</a></button>
                </div>
              </section>
                  ...
                  <table class="table" >
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href={{"update/".$member['id']}} class="text-black btn btn-succes ml-2 pt-2">
                            <i class="fa-sharp fa-solid fa-pen-to-square"></i>
                          </a>
                          <a href={{"delete/".$member['id']}} class="text-black btn btn-succes ml-2 pt-2">
