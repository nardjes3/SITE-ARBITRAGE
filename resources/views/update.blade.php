  ...
  <div class="container">
   ...
   <div class="main">
    ...
    <form action="/update" method="post">
        ...
        <input type="text" name="level" value="{{$data['level']}}" placeholder="Enter level">
        <br><br>
        ...
        <input type="text" name="b" value="{{$data['a']}}"  placeholder="Enter answer2">
        <input type="text" name="c" value="{{$data['a']}}"  placeholder="Enter answer3">
        <input type="text" name="d" value="{{$data['a']}}"  placeholder="Enter answer4"> 
        <br><br>   
