                  ...
                  <div class="card_inner" data-state="#about">
                    ...
                    <div class="card-header">
                        ...
                        <div class="pro_title"> 
                          ...
                          <h6> Last Name : <Font class="lname" size="2pt" color="black">Smith</Font></h6>
                          <h6> Email : <Font class="mail" size="2pt" color="black">Smith@gmail.com</Font></h6>
                          ...
                          <div class="btn" style="display: flex">
                            <a href="#addEmployeeModal" class="btn-success" data-toggle="modal">
                               <button class="show-modal" style="display: flex"><img src="images/imagesAdmin/add.png" style="width: 25px; margin-left:7px" alt=""><h4 style="margin-left: 3px; margin-top:8px">  Add new arbiter</h4></button></a>
                                ...
                                @foreach ($instructor_phis as $instructor_phi)
                                  <div class="list" >
                            
                            <div class="imgbox" style="background-image: url('images/imagesAdmin/ar05.jpg;" data-title=" {{$instructor_phi['nom']}} {{$instructor_phi['prenom']}}" nom="{{$instructor_phi['nom']}}" prenom="{{$instructor_phi['prenom']}}" email="{{$instructor_phi['email']}}"   pays="{{$instructor_phi['adresse']}}"   id="{{$instructor_phi['id']}}">
                            </div>
                            <h4 class="content">
                                {{$instructor_phi['nom']}} {{$instructor_phi['prenom']}}
                            </h4>
