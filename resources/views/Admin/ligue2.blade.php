...
<body style="background-image:url({{asset('images/imagesAdmin/val.png')}}); background-repeat:no-repeat; background-attachment:fixed; background-size:100% 100%; ">
  @include('Admin/menu')
        ...
        <section class="table__body">
            <table>
                ...
                <tbody>
                  ...
                  <?php if ($rencontre['day'] == $rencs && $rencontre['ligue'] == 2) : ?>
                    <tr>
...
<div class="jour">
      ...
      <a href="/ligue2/1"><button > Day 1 </button></a>

      <a href="/ligue2/2"><button > Day 2 </button></a>

        <a href="/ligue2/3"><button > Day 3 </button></a>

        <a href="/ligue2/4"><button> Day 4 </button></a>

        <a href="/ligue2/5"><button> Day 5 </button></a>

        <a href="/ligue2/6"><button> Day 6 </button></a>

        <a href="/ligue2/7"><button> Day 7 </button></a>

        <a href="/ligue2/8"><button> Day 8 </button></a>
